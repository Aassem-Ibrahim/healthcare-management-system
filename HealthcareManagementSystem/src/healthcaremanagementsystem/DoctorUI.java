...
public class DoctorUI extends javax.swing.JFrame {
    public DoctorUI() {
        this(true, new Doctor());  /* Enable edit for new doctor */
    ...
    private int FormValidity() {
        ...
        if (doctor.index == -1) return FORM_E_DB;
        ...
        else if (tfSpeciality.getText().equals(CLEARED_SPECIALITY)) return FORM_E_SPECIALITY;
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(jlID, javax.swing.GroupLayout.DEFAULT_SIZE, 66, Short.MAX_VALUE))
    ...
    private void bSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bSaveActionPerformed
        ...
        switch(FormValidity()) {
            ...
            case FORM_E_ID -> showErrorSaving(EMSG_ID);
            case FORM_E_UID -> showErrorSaving(EMSG_UID);
            case FORM_E_NAME -> showErrorSaving(EMSG_NAME);
            case FORM_E_ADDRESS -> showErrorSaving(EMSG_ADDRESS);
            case FORM_E_PHONE -> showErrorSaving(EMSG_PHONE);
            case FORM_E_SPECIALITY -> showErrorSaving(EMSG_SPECIALITY);
        }
